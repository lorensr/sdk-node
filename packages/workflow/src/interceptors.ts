...
import { ActivityOptions, WorkflowExecution, Headers, Next, Deserialized } from '@temporalio/common';
...
export interface ConcludeActivationInput {
  commands: Deserialized<coresdk.workflow_commands.IWorkflowCommand>[];
}
...
export interface ActivateInput {
  activation: Deserialized<coresdk.workflow_activation.IWFActivation>;
  batchIndex: number;
}
...
export interface WorkflowInternalsInterceptor {
  ...
  /**
   * Called after all `WFActivationJob`s have been processed for an activation.
   *
